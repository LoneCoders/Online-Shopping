...
var showAlert = function showAlert(type, msg) {
  hideAlert();
  var markUp = "<div class=\"alert alert--".concat(type, "\">").concat(msg, "</div>"); // insert alert box in out html
...
var signUp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(firstName, secondName, email, password, confirmPassword) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'SignedUp Successfully');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var signUpForm = document.querySelector('.signUpForm'); //DELEGATION
